                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row pb-3">
                            ...
                            <div class="col-md-6 col-2 col-lg-4 col-sm-12 col-12 pt-3 ">
                                <a href=" {{ url('/acciones') }}"
                                    class="botones-inicio btn btn-block btn-white btn-sm p-3 shadow btn-hover">
                                    <h4 class="text-left fs-4 title-home"><i class="bi bi-hdd-stack-fill"></i> Control de
                                        Acciones
                                    </h4>
                                    <p class="text-left fw-lighter description-home">
                            ...
                            <div class="col-md-6 col-2 col-lg-4 col-sm-12 col-12 pt-3 ">
                                <a href=" {{ url('/usuarios') }}"
                                    class="botones-inicio btn btn-block btn-white btn-sm p-3 shadow btn-hover">
                                    <h4 class="text-left fs-4 title-home"><i class="bi bi-person-fill"></i> Manejo de Usuarios
                                    </h4>
                                    <p class="text-left fw-lighter description-home">
